<?php
  ...
  */
  ...
  //create template
  $xmltemplate = new SB_XMLTemplate();

  $xmltemplate->ID                = "Template";
  $xmltemplate->Session           = $_SESSION;
  $xmltemplate->Request           = $_REQUEST;
  $xmltemplate->Params            = "";
  //$xmltemplate->IDPrefix  = $moduleprefix . "_";
  //$xmltemplate->ContainerID       = $senderid;
  //$xmltemplate->ContainerJSID     = $senderjsid;
  //$xmltemplate->ContainerClass    = $senderclass;
  $xmltemplate->Filename          = $templatefilename;
  $xmltemplate->RootPath          = dirname(__FILE__) . "/../";
  $xmltemplate->CustomPath        = dirname(__FILE__) . "/../usersettings/" . stripouterslashes($_SESSION["project"]["organisatiedirectory"]);;
  //$xmltemplate->ModuleName        = $modulenaam;
  //$xmltemplate->ModulePath        = $modulepath;
  $xmltemplate->Result            = $result;
  $xmltemplate->ResultArray       = $resultarray;

  $xmltemplate->readTemplate();
  $xmltemplate->init();
